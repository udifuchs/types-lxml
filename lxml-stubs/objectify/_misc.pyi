...
) -> etree.ElementTree[ObjectifiedElement]:
...
class ObjectPath:
    ...
    find = __call__
    def hasattr(self, root: etree.Element) -> bool: ...
    def setattr(self, root: etree.Element, value: object) -> None: ...
    def addattr(self, root: etree.Element, value: object) -> None: ...
